...
(function () {
  ...
  const depth = document.body.dataset.depth || "../../"; // desde modules/XX/ hacia docs/master-exercise-dataset/ (raíz del handbook)
    ...
    mount.innerHTML = `
      <div class="topbar">
        ...
        <a class="topbar__brand" href="${depth}modules/00-introduccion/index.html">
          ...
          BREY <span class="topbar__brand-sub">Master Exercise Dataset</span>
        </a>
        <div class="topbar__search">
          <span class="topbar__search-icon">${ICON_SEARCH}</span>
          <input id="search-input" type="text" placeholder="Buscar en el dataset…" autocomplete="off" />
  ...
  function renderBreadcrumbs() {
    ...
    mount.innerHTML = `
      <nav class="breadcrumbs" aria-label="Breadcrumb">
        <a href="${depth}modules/00-introduccion/index.html">Dataset</a>
        <span>/</span>
