  ...
  return (
    <LegalShell title="Política de Privacidad" updated="julio 2026">
      ...
      <ul>
        ...
        <li><strong>Datos de compra</strong>, gestionados por la plataforma de pago (como Hotmart) cuando adquieres un Sistema. No almacenamos datos de tarjetas.</li>
      ...
      <ul>
        ...
        <li>Darte acceso a los Sistemas que compraste y soporte sobre ellos.</li>
