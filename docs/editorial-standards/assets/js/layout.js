...
(function () {
  ...
  const depth = document.body.dataset.depth || "../../"; // desde modules/XX/ hacia docs/editorial-standards/ (raíz del handbook)
    ...
    mount.innerHTML = `
      <div class="topbar">
        ...
        <a class="topbar__brand" href="${depth}modules/00-introduccion/index.html">
          ...
          BREY <span class="topbar__brand-sub">Editorial Standards</span>
        </a>
