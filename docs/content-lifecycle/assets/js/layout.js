...
(function () {
  ...
  const depth = document.body.dataset.depth || "../../"; // desde modules/XX/ hacia docs/content-lifecycle/ (raíz del handbook)
    ...
    mount.innerHTML = `
      <div class="topbar">
        ...
        <a class="topbar__brand" href="${depth}modules/00-introduccion/index.html">
          ...
          BREY <span class="topbar__brand-sub">Content Lifecycle</span>
        </a>
