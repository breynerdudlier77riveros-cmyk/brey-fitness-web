...
export const posts: Post[] = [
  {
    ...
    body: [
      ...
      "#### Un inciso: qué es un newton-metro",
      "El resultado de esa multiplicación se expresa en **newton-metros (N·m)**, y vale la pena entenderlo, porque es la unidad de todo lo que viene después.",
      "Un **newton** es una fuerza: la que ejerce hacia abajo un peso de unos cien gramos. Diez newtons son, más o menos, un kilo colgando de tu mano.",
      "Un **newton-metro ya no es una fuerza: es un giro.** Es lo que consigues cuando aplicas esa fuerza a cierta distancia de un eje. Piensa en una puerta: empujada pegado a la bisagra no cede por mucho que aprietes, y empujada por el pomo se abre sola. La fuerza de tu brazo es la misma en los dos casos. Lo que cambia es la distancia al eje, y con ella el giro que produces.",
      "Y aquí está lo que conecta la física con lo que sientes: **tus músculos no «levantan peso», producen giro alrededor de una articulación.** La gravedad genera un giro que te tira hacia el suelo; tú tienes que generar otro igual en sentido contrario. Mientras los dos se igualan, la posición se sostiene. En cuanto el tuyo se queda corto, te caes. No hay más.",
      "Por eso los momentos de esta guía se miden en newton-metros y no en kilos: lo que se le pide a ese hombro no es soportar un peso, es impedir un giro.",
      "> **Regla rápida para leer las cifras:** divide los N·m entre diez y tendrás, tirando por lo bajo, los kilos que estarías sosteniendo con el brazo extendido a un metro. 100 N·m son unos 10 kg a esa distancia.",
  ...
  },
  {
    ...
    body: [
      ...
      "Un **newton-metro ya no es una fuerza: es un giro.** Es lo que consigues cuando aplicas esa fuerza a cierta distancia de un eje. Piensa en una puerta: empujada pegado a la bisagra no cede por mucho que aprietes, y empujada por el pomo se abre sola. La fuerza de tu brazo es la misma en los dos casos. Lo que cambia es la distancia al eje, y con ella el giro que produces.",
      "Y aquí está lo que conecta la física con lo que sientes: **tus músculos no «levantan peso», producen giro alrededor de una articulación.** La gravedad genera un giro que te tira hacia el suelo; tú tienes que generar otro igual en sentido contrario. Mientras los dos se igualan, la posición se sostiene. En cuanto el tuyo se queda corto, te caes. No hay más.",
      "Por eso los torques de esta guía se miden en newton-metros y no en kilos: lo que se le pide a ese hombro no es soportar un peso, es impedir un giro.",
      "> **Regla rápida para leer las cifras:** divide los N·m entre diez y tendrás, tirando por lo bajo, los kilos que estarías sosteniendo con el brazo extendido a un metro. 100 N·m son unos 10 kg a esa distancia.",
